...
typedef struct
{
    ...
    unsigned char contex0_data_type;  //MIPI_YUV422 MIPI_RAW8 MIPI_RAW10 MIPI_RAW12
...
struct sensor_pwd_info {
    ...
    struct dts_gpio rear_gpio_reset;
 	struct dts_gpio front_gpio_reset;
    struct clk *ch_clk[2];
};
