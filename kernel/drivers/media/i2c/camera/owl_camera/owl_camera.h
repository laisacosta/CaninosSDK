...
struct owl_camera_hw_ops
{
    ...
    int (*clear_channel_preline_pending)(struct owl_camera_hw_adapter* hw, unsigned int isp_int_stat, int channel);
    int (*clear_channel_frameend_pending)(struct owl_camera_hw_adapter* hw, unsigned int isp_int_stat, int channel);
	...
	int (*restore_regs)(struct owl_camera_hw_adapter* hw); 
 	int (*dump_isp_reg)(struct owl_camera_hw_adapter* hw, int channel);	
  	...
  	int (*mipi_csi_init)(struct owl_camera_hw_adapter* hw,struct soc_camera_device *icd);
};
